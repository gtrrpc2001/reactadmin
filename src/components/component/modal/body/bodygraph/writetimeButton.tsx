...
export const WritetimeButton = ({ onClick, clickWritetimeButton }: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        <Typography sx={{ color: todayChildren }}>{"Today"}</Typography>
      </Button>
      <Button
        id="days2"
        onClick={(e) => onClick(e)}
      ...
      >
        <Typography sx={{ color: days2Children }}>{"2 Days"}</Typography>
      </Button>
      <Button
        id="days3"
        onClick={(e) => onClick(e)}
      ...
      >
        <Typography sx={{ color: days3Children }}>{"3 Days"}</Typography>
      </Button>
    </Box>
  );
};
